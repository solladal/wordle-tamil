...
// Shared "how to play" content used both inside the in-game Help modal
// (components/Help.js) and the standalone, crawlable /how-to-play page
// (pages/HowToPlayPage.js), so the rules are written once and stay in sync.
export class HelpContent extends React.Component {
  constructor(props) {
    super(props);
